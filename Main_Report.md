...
- **Số lượng TCs AI sinh ra:** `[Đợi AI sinh xong sẽ điền]`
...
| Test Case ID              | Test Scenario                                                                                                                 | Request Body (JSON)                                                                                              | Expected Status         | Expected Response                                                                    |
| :------------------------ | :---------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------- | :---------------------- | :----------------------------------------------------------------------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **TC_COUPON_01**          | Happy Path (Percent): Mọi điều kiện hợp lệ. Dùng mã `SAVE10` với đơn 500k. (Giảm 10%).                                        | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 500000,`<br>`"user_id": 1`<br>`}`                                 | `200 OK`                | `{"discount_amount": 50000, "final_amount": 450000}`                                 |
| **TC_COUPON_02**          | Happy Path (Fixed): Mọi điều kiện hợp lệ. Dùng mã `VIP100` với đơn 400k. (Giảm 100k).                                         | `{`<br>`"code": "VIP100",`<br>`"total_amount": 400000,`<br>`"user_id": 2`<br>`}`                                 | `200 OK`                | `{"discount_amount": 100000, "final_amount": 300000}`                                |
| **TC_COUPON_03**          | Boundary (C3=True): Đơn hàng vừa đúng ngưỡng tối thiểu 300k với mã `SAVE10`.                                                  | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 300000,`<br>`"user_id": 3`<br>`}`                                 | `200 OK`                | `{"discount_amount": 30000, "final_amount": 270000}`                                 |
| **TC_COUPON_04**          | Happy Path (Fixed): Dùng mã `BIGBUY` với đơn đúng ngưỡng 500k.                                                                | `{`<br>`"code": "BIGBUY",`<br>`"total_amount": 500000,`<br>`"user_id": 4`<br>`}`                                 | `200 OK`                | `{"discount_amount": 50000, "final_amount": 450000}`                                 |
| **TC_COUPON_05**          | Vi phạm C1: Mã giảm giá không tồn tại hoặc đã bị vô hiệu hóa (is_active = 0).                                                 | `{`<br>`"code": "NOTFOUND",`<br>`"total_amount": 500000,`<br>`"user_id": 1`<br>`}`                               | `400 Bad Request`       | `{"error": "Coupon code does not exist or is inactive"}`                             |
| **TC_COUPON_06**          | Vi phạm C2: Mã giảm giá đã hết hạn (Dùng mã `EXPIRED`).                                                                       | `{`<br>`"code": "EXPIRED",`<br>`"total_amount": 500000,`<br>`"user_id": 1`<br>`}`                                | `400 Bad Request`       | `{"error": "Coupon code has expired"}`                                               |
| **TC_COUPON_07**          | Vi phạm C3 (Boundary): Đơn hàng thiếu 1 VNĐ so với ngưỡng tối thiểu (299,999 đ) của `SAVE10`.                                 | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 299999,`<br>`"user_id": 5`<br>`}`                                 | `400 Bad Request`       | `{"error": "Total amount does not meet the minimum requirement"}`                    |
| **TC_COUPON_08**          | Vi phạm C3: Đơn hàng không đủ ngưỡng tối thiểu cho `BIGBUY` (499,999 đ).                                                      | `{`<br>`"code": "BIGBUY",`<br>`"total_amount": 499999,`<br>`"user_id": 6`<br>`}`                                 | `400 Bad Request`       | `{"error": "Total amount does not meet the minimum requirement"}`                    |
| **TC_COUPON_09**          | Vi phạm C5: User đã sử dụng mã `SAVE10` 1 lần trước đó (Vượt giới hạn max_use = 1).                                           | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 500000,`<br>`"user_id": 99`<br>`}`                                | `400 Bad Request`       | `{"error": "Coupon usage limit exceeded for this user"}`                             |
| **TC_COUPON_10**          | Trạng thái C5 hợp lệ: User dùng mã `VIP100` lần thứ 2 (Ngưỡng max_use = 2).                                                   | `{`<br>`"code": "VIP100",`<br>`"total_amount": 300000,`<br>`"user_id": 7`<br>`}`                                 | `200 OK`                | `{"discount_amount": 100000, "final_amount": 200000}`                                |
| **TC_COUPON_11**          | Vi phạm C5: User cố gắng dùng mã `VIP100` lần thứ 3 (Vượt giới hạn max_use = 2).                                              | `{`<br>`"code": "VIP100",`<br>`"total_amount": 400000,`<br>`"user_id": 7`<br>`}`                                 | `400 Bad Request`       | `{"error": "Coupon usage limit exceeded for this user"}`                             |
| **TC_COUPON_12**          | Vi phạm C4: Không gửi JWT Token hợp lệ trên Header (Lỗi Xác thực).                                                            | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 500000,`<br>`"user_id": 1`<br>`}`                                 | `401 Unauthorized`      | `{"error": "Invalid or missing authentication token"}`                               |
| **TC_COUPON_13**          | Tổ hợp vi phạm (C2 + C3): Mã vừa hết hạn, đơn hàng vừa không đủ ngưỡng.                                                       | `{`<br>`"code": "EXPIRED",`<br>`"total_amount": 50000,`<br>`"user_id": 8`<br>`}`                                 | `400 Bad Request`       | `{"error": "Coupon code has expired"}`                                               |
| **TC_COUPON_14**          | Tổ hợp vi phạm (C1 + C3): Mã không tồn tại và đơn giá siêu thấp (10k).                                                        | `{`<br>`"code": "INVALID",`<br>`"total_amount": 10000,`<br>`"user_id": 9`<br>`}`                                 | `400 Bad Request`       | `{"error": "Coupon code does not exist or is inactive"}`                             |
| **TC_COUPON_15**          | Tổ hợp vi phạm (C3 + C5): Đơn hàng không đủ tiền và user đã vượt lượt dùng.                                                   | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 200000,`<br>`"user_id": 99`<br>`}`                                | `400 Bad Request`       | Phụ thuộc vào thứ tự xử lý của Backend (Có thể trả về lỗi Threshold hoặc lỗi Limit). |
| **TC_COUPON_16**          | Boundary (Negative): `total_amount` bằng 0.                                                                                   | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 0,`<br>`"user_id": 1`<br>`}`                                      | `400 Bad Request`       | `{"error": "Total amount must be greater than 0"}`                                   |
| **TC_COUPON_17**          | Boundary (Negative): `total_amount` là số âm.                                                                                 | `{`<br>`"code": "SAVE10",`<br>`"total_amount": -500000,`<br>`"user_id": 1`<br>`}`                                | `400 Bad Request`       | `{"error": "Total amount must be a positive number"}`                                |
| **TC_COUPON_18**          | Boundary (Negative): `total_amount` siêu lớn gây tràn bộ nhớ (Buffer Overflow).                                               | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 999999999999999,`<br>`"user_id": 1`<br>`}`                        | `400 Bad Request`       | `{"error": "Total amount exceeds maximum allowed limit"}`                            |
| **TC_COUPON_19**          | Schema: Bỏ trống trường `code` (Missing field).                                                                               | `{`<br>`"total_amount": 500000,`<br>`"user_id": 1`<br>`}`                                                        | `400 Bad Request`       | `{"error": "Coupon code is required"}`                                               |
| **TC_COUPON_20**          | Schema: Bỏ trống trường `total_amount` (Missing field).                                                                       | `{`<br>`"code": "SAVE10",`<br>`"user_id": 1`<br>`}`                                                              | `400 Bad Request`       | `{"error": "Total amount is required"}`                                              |
| **TC_COUPON_21**          | Schema: Bỏ trống trường `user_id` (Missing field).                                                                            | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 500000`<br>`}`                                                    | `400 Bad Request`       | `{"error": "User ID is required"}`                                                   |
| **TC_COUPON_22**          | Schema: Gửi payload rỗng (Empty body).                                                                                        | `{}`                                                                                                             | `400 Bad Request`       | `{"error": "Code, total_amount, and user_id are required"}`                          |
| **TC_COUPON_23**          | Schema: `total_amount` truyền dạng chuỗi String thay vì Number.                                                               | `{`<br>`"code": "SAVE10",`<br>`"total_amount": "500000",`<br>`"user_id": 1`<br>`}`                               | `400 Bad Request`       | `{"error": "Invalid data type for total_amount"}`                                    |
| **TC_COUPON_24**          | Schema: `total_amount` truyền kiểu Boolean.                                                                                   | `{`<br>`"code": "SAVE10",`<br>`"total_amount": true,`<br>`"user_id": 1`<br>`}`                                   | `400 Bad Request`       | `{"error": "Invalid data type for total_amount"}`                                    |
| **TC_COUPON_25**          | Schema: `total_amount` truyền giá trị Null.                                                                                   | `{`<br>`"code": "SAVE10",`<br>`"total_amount": null,`<br>`"user_id": 1`<br>`}`                                   | `400 Bad Request`       | `{"error": "Total amount cannot be null"}`                                           |
| **TC_COUPON_26**          | Schema: `user_id` truyền dạng chuỗi String thay vì Number.                                                                    | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 500000,`<br>`"user_id": "1"`<br>`}`                               | `400 Bad Request`       | `{"error": "Invalid data type for user_id"}`                                         |
| **TC_COUPON_27**          | Schema: `user_id` truyền số thập phân (Float/Decimal).                                                                        | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 500000,`<br>`"user_id": 1.5`<br>`}`                               | `400 Bad Request`       | `{"error": "User ID must be an integer"}`                                            |
| **TC_COUPON_28**          | Schema: `code` truyền kiểu số nguyên (Integer).                                                                               | `{`<br>`"code": 12345,`<br>`"total_amount": 500000,`<br>`"user_id": 1`<br>`}`                                    | `400 Bad Request`       | `{"error": "Invalid data type for code"}`                                            |
| **TC_COUPON_29**          | Security (IDOR): Dùng Token JWT của User A nhưng truyền `user_id: 2` (User B).                                                | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 500000,`<br>`"user_id": 2`<br>`}`                                 | `403 Forbidden`         | `{"error": "You do not have permission to perform this action for another user"}`    |
| **TC_COUPON_30**          | Security (Mass Assignment): Cố tình nhét thêm trường tính toán vào body.                                                      | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 500000,`<br>`"user_id": 1,`<br>`"discount_amount": 500000`<br>`}` | `400 Bad Request`       | `{"error": "Invalid fields in request payload"}`                                     |
| **TC_COUPON_31**          | Security (SQL Injection): Truyền mã SQL độc hại vào `code`.                                                                   | `{`<br>`"code": "' OR 1=1 --",`<br>`"total_amount": 500000,`<br>`"user_id": 1`<br>`}`                            | `400 Bad Request`       | `{"error": "Invalid coupon code format"}`                                            |
| **TC_COUPON_32**          | Security (XSS): Truyền mã Script độc hại vào `code`.                                                                          | `{`<br>`"code": "<script>alert('XSS')</script>",`<br>`"total_amount": 500000,`<br>`"user_id": 1`<br>`}`          | `400 Bad Request`       | `{"error": "Invalid characters in coupon code"}`                                     |
| **TC_COUPON_33**          | Security (Rate Limiting): Gửi 100 requests đồng thời trong 1 giây để trục lợi lượt dùng.                                      | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 500000,`<br>`"user_id": 1`<br>`}`                                 | `429 Too Many Requests` | `{"error": "Too many requests, please try again later"}`                             |
| **TC_COUPON_34**          | Security (Broken Authentication): Header chứa JWT rác.                                                                        | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 500000,`<br>`"user_id": 1`<br>`}`                                 | `401 Unauthorized`      | `{"error": "Invalid authentication token"}`                                          |
| **TC_COUPON_35**          | Security (Broken Authentication): Header chứa JWT đã hết hạn.                                                                 | `{`<br>`"code": "SAVE10",`<br>`"total_amount": 500000,`<br>`"user_id": 1`<br>`}`                                 | `401 Unauthorized`      | `{"error": "Token has expired"}`                                                     |
